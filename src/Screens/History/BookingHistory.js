    ...
    (
      <View activeOpacity={0.7} style={styles.userItemContainer}>
        ...
        <View style={styles.userNameContainer}>
          ...
          <Text style={styles.userName}>
            Schedule with: {item?.item?.username}
          </Text>
        </View>
        ...
        <View>
          ...
          <Button
            ...
            onPress={() => {
              this.props.navigation.navigate('EnterReview', {
                coach_id: item?.item?.user_id,
                coachImg: item?.item?.coachImg,
                coach_username: item?.item?.username,
              });
            }}
            textStyle={{color: Colors.WHITE, fontSize: 12, fontWeight: 'none'}}
          />
        </View>
      </View>
    )
