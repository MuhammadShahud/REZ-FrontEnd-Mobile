            ...
            <View style={styles.confirmationSheetContainer}>
                ...
                <View style={styles.sheetBody}>
                    <Image
                        ...
                        resizeMode={'contain'}
                    />
                    <Text style={styles.sheetHeading}>Contract Created </Text>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 50 }}>
                        <View style={styles.inputContainer}>
                            <TextInput
                                ...
                                onChangeText={text => this.setState({ ContractTitle: text })}
                            />
                        </View>
                        ...
                        <View style={styles.inputContainer}>
                            <TextInput
                                ...
                                onChangeText={text => this.setState({ passes: text })}
                            />
                        </View>

                        <View style={styles.inputContainer}>
                            <SelectDropdown
                                data={this.state.RenewOptions}
                                defaultButtonText={"Renewable"}
                                // defaultValue={this.state.sportTypeId}
                                dropdownIconPosition="right"
                                renderDropdownIcon={() => {
                                    return (
...
const mapDispatchToProps = dispatch => ({
    createContract: payload => dispatch(PackagesMiddleware.createContract(payload)),
