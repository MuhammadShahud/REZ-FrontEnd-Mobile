                            ...
                            <View style={styles.Details}>
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text style={styles.ShortHeading}>Sub Room Name :</Text>
                                        <Text style={styles.ShortHeadingInner}> {item.name}</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', marginVertical: 5 }}>
                                        <Text style={styles.ShortHeading}>Room Assigned (Staff Name) :</Text>
                                        <Text style={styles.ShortHeadingInner} numberOfLines={2} > {item.staff.length > 0 && item.staff.map((data, index) => {
                                            return item.staff.length - 1 == index ? data.username : `${data.username}, `
                                        })}</Text>
                                    </View>
